...
{{- else -}}
	...
	var {{$tAlias.UpPlural}} *{{$tAlias.UpSingular}}Table = {{$.Dialect}}.NewTablex[*{{$tAlias.UpSingular}}, {{$tAlias.UpSingular}}Slice, *{{$tAlias.UpSingular}}Setter]("{{$table.Name}}", {{uniqueColPairs $table}})
